...
check example: https://github.com/JuliaShul/psbank-tests

<!--
**JuliaShul/JuliaShul** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
